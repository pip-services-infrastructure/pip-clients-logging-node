# Development and Testing Guide <br/> Logging Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-infrastructure/pip-clients-logging-node.git
```
